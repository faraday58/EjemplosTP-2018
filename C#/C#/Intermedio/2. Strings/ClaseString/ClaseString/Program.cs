...
namespace ClaseString
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Replace: " + cadena.Replace(" ", "")); //Replace(string str, string NuevaStr);
            ...
            Console.WriteLine("Substring (1-8): " + cadena.Substring(1, 8)); //Substring(int pos, int nchars) indice a partir del cual se formala nueva cadena de nchars
            ...
            Console.WriteLine("cadena termina  con \"La\"? " + cadena.EndsWith("Le"));
